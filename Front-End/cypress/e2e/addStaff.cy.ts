...
import {userAdmin,staffRecord, timeOut, updateStaffRecord, updateStoreRecord, staffRecord2, staffRecord3} from './e2e-constants.cy'
...
describe('CompanyLogin > staff > AddStaff', () => {
  ...
  it('EditStaff', () => {    
    ...
    cy.get('[id="confirmPassword"]').eq(0).click({force: true}).clear({force: true})
