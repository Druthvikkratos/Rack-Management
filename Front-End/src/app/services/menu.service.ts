...
export class MenuService {
  ...
  templateDropdownRemoveUnderScore(obj) {
    const removeUnderScore = obj.map(e => ({...e, label: e.label.replace(/_/g, ' ') }))
  ...
  templateListingRemoveUnderScore(obj) {
    const removeUnderScore = obj.map(e => ({...e, name: e.name.replace(/_/g, ' '), description: e.description.replace(/_/g, ' ') }))
