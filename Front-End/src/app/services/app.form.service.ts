...
export class FormService {
  ...
  delete(id: number, name: string, schemaName): Observable<Item> {
    return this.http.delete(`${baseUrl}/api/items/${id}/${name}/${schemaName}`)
  }
  ...
  fetchUpperAndLowerLimit(formId: number, trayId: number): Observable<Item> {
    return this.http.get<Item>(
      `${baseUrl}/api/form/findByForm/${formId}?trayId=${trayId}`
    )
  }
