  ...
  async removeForm(row_obj): Promise<void> {
    try {
      swal({
        ...
        text: 'By deleting this Translate it will also deletes the associated menus which are available for you, Do you want to procced?',
        type: 'warning',
      ...
      await this.deleteRowData(row_obj)
    } catch (e) {
