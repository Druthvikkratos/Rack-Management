...
export class RackListComponent implements OnInit {
  ...
  deleteRack(id): void {
    ...
    swal({
      ...
      text: 'By deleting this Rack it will also deletes related trays and tray items of this Rack, Do you want to procced?',
      type: 'warning',
  ...
  deleteRackById(id: number): void {
    ...
    this.rackService.deleteRackById(id).subscribe(response => {
      this.rackObject = response
