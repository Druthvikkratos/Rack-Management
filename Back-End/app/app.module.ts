...
import itemTemplateControllers from "./controller/itemtemplate.controller"
import ItemTemplatePropertyController from "./controller/itemTemplateProperty.controller"
...
@Module({
  ...
  controllers: [
    ...
    formControllers,
    TemplateControllers,
    itemTemplateControllers,
    ItemTemplatePropertyController,
    AuthController,
    SupportController
