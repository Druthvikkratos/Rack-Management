...
import {IRackSearch, UpdateTrayLayout} from "../service/rack.service"
...
export default class RackController {
  constructor(
    ...
    private rackSevice: RackService
  ) {}
  @Post("/createRack")
  ...
  public async findAllRackOnClientFk(
    ...
    try {
      return await this.rackSevice.findAllRackOnClientFk(+client_fk)
    } catch (e) {
      throw new HttpException(
  ...
  @Delete("/:id")
  public async deleteRackById(@Param("id") id: string): Promise<string> {
    try {
      return await this.rackSevice.deleteRackById(+id)
    } catch (e) {
      throw new HttpException(
  ...
  public async fetchRackByClientId(
    ...
    try {
      return await this.rackSevice.fetchRackByClientId(name, +client_fk)
    } catch (e) {
      throw new HttpException(
  ...
  @Post("/searchRack")
  public async searchRack(@Body() body: IRackSearch): Promise<IRackSearch> {
    try {
      return await this.rackSevice.searchRack(body)
    } catch (e) {
      throw new HttpException(
        "Error in RackController.searchRack",
        HttpStatus.INTERNAL_SERVER_ERROR
      )
    }
  }
  ...
  @Delete("/tray/:id")
  public async deleteTrayById(@Param("id") id: string): Promise<string> {
    try {
      return await this.rackSevice.deleteTrayById(+id)
    } catch (e) {
      throw new HttpException(
  ...
  public async deleteTrayItem(
    @Param("formId") formId: string
  ): Promise<string> {
    try {
      return await this.rackSevice.deleteTrayItem(+formId)
    } catch (e) {
      throw new HttpException(
  ...
  public async deleteTrayItemByFormAndTrayId(
    ...
    try {
      return await this.rackSevice.deleteTrayItemByFormAndTrayId(
        +trayid,
        +formid
      )
    } catch (e) {
  ...
  public async fetchTrayDataByRackId(
    @Param("rack_fk") rack_fk: string
  ): Promise<Tray[]> {
    try {
      return await this.rackSevice.fetchTrayDataByRackId(+rack_fk)
    } catch (e) {
      throw new HttpException(
  ...
  public async fetchTrayPropByRackId(
    ...
    try {
      return await this.rackSevice.fetchTrayPropByRackId(+rack_fk)
    } catch (e) {
      throw new HttpException(
