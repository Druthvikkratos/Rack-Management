...
export default class NotificationController {
  constructor(private notififcationService: NotificationService) {}
  ...
  public async fetchAllNotification(
    ...
    try {
      return await this.notififcationService.fetchAllNotification(emailData)
    } catch (e) {
      throw new HttpException(
  ...
  public async updateNewNotificationToOld(
    ...
    try {
      const idsArray = JSON.parse("[" + notificationIDs + "]");
       return this.notififcationService.updateNewNotificationToOld(idsArray)
    } catch (e) {
      throw new HttpException(
